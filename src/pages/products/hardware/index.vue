<template>
    <div class="products">
        ...
        <sc-cards-list :items="filteredItems" type="products" hideOverlay/>
...
<script>
  ...
  import ScCallToAction from "~/components/sc-call-to-action";
            ...
            if (res.items.length > 0) {
              ...
              if (typeof response !== 'undefined') {
                if (typeof response.fields.paragraphs !== 'undefined') {
                  this.title = response.fields.paragraphs.filter((p) => p.fields.name === 'scala-hardware-headertitle')[0].fields.title;
                  this.subtitle = response.fields.paragraphs.filter((p) => p.fields.name === 'scala-hardware-headertitle')[0].fields.description;
                }
              }
