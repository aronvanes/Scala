    ...
    <div v-if="ready">
        <div class="index-header">
            <div class="width-container" style="display:flex; flex-flow: row;justify-content: space-between; align-items:center;" >
                <sc-paragraph-title :name="$store.getters.translation('general.thanks')" first></sc-paragraph-title>
            </div>
        </div>

        <div class="width-container" style="margin-top: -5em;" v-if="ctaName">
